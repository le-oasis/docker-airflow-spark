...
spark_job_load_postgres = SparkSubmitOperator(
    ...
    application="/usr/local/spark/app/postgres/load-postgres.py", # Spark application path created in airflow and spark cluster
    name="load-postgres",
...
spark_job_read_postgres = SparkSubmitOperator(
    ...
    application="/usr/local/spark/app/postgres/read-postgres.py", # Spark application path created in airflow and spark cluster
    name="read-postgres",
    conn_id="spark_connect",
    verbose=1,
    conf={"spark.master":spark_master},
